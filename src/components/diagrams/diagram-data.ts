    ...
    nodes: [
      {
        id: "gateway",
        type: "service",
        data: { label: "API Gateway", animationDelay: 0 },
        position: { x: 0, y: 100 },
      },
      {
        id: "auth",
        type: "service",
        data: { label: "Auth Service", animationDelay: 0.2 },
        position: { x: 250, y: 0 },
      },
      {
        id: "core",
        type: "service",
        data: { label: "Core Agent", animationDelay: 0.2 },
        position: { x: 250, y: 100 },
      },
      {
        id: "queue",
        type: "queue",
        data: { label: "Task Queue", animationDelay: 0.4 },
        position: { x: 500, y: 100 },
      },
      {
        id: "db",
        type: "database",
        data: { label: "PostgreSQL", animationDelay: 0.4 },
    ...
    nodes: [
      {
        id: "client",
        type: "service",
        data: { label: "Client", animationDelay: 0 },
        position: { x: 0, y: 100 },
      },
      {
        id: "gateway",
        type: "service",
        data: { label: "API Gateway", animationDelay: 0.2 },
        position: { x: 250, y: 100 },
      },
      {
        id: "service-a",
        type: "service",
        data: { label: "Service A", animationDelay: 0.4 },
        position: { x: 500, y: 0 },
      },
      {
        id: "service-b",
        type: "service",
        data: { label: "Service B", animationDelay: 0.4 },
    ...
    nodes: [
      {
        id: "input",
        type: "service",
        data: { label: "Input Handler", animationDelay: 0 },
        position: { x: 0, y: 100 },
      },
      {
        id: "analyzer",
        type: "service",
        data: { label: "Code Analyzer", animationDelay: 0.2 },
        position: { x: 250, y: 100 },
      },
      {
        id: "llm",
        type: "service",
        data: { label: "LLM (GPT-4)", animationDelay: 0.4 },
        position: { x: 500, y: 100 },
      },
      {
        id: "output",
        type: "service",
        data: { label: "Review Generator", animationDelay: 0.6 },
    ...
    nodes: [
      {
        id: "orchestrator",
        type: "service",
        data: { label: "Saga Orchestrator", animationDelay: 0 },
        position: { x: 0, y: 100 },
      },
      {
        id: "step1",
        type: "service",
        data: { label: "Payment Service", animationDelay: 0.2 },
        position: { x: 250, y: 0 },
      },
      {
        id: "step2",
        type: "service",
        data: { label: "Stock Service", animationDelay: 0.2 },
        position: { x: 250, y: 200 },
      },
    ],
    edges: [
    ...
    nodes: [
      {
        id: "apps",
        type: "service",
        data: { label: "Applications", animationDelay: 0 },
        position: { x: 0, y: 100 },
      },
      {
        id: "prometheus",
        type: "service",
        data: { label: "Prometheus", animationDelay: 0.2 },
        position: { x: 250, y: 0 },
      },
      {
        id: "loki",
        type: "service",
        data: { label: "Loki", animationDelay: 0.2 },
        position: { x: 250, y: 200 },
      },
      {
        id: "grafana",
        type: "service",
        data: { label: "Grafana", animationDelay: 0.4 },
        position: { x: 500, y: 100 },
      },
    ],
    edges: [
    ...
    nodes: [
      {
        id: "github",
        type: "service",
        data: { label: "GitHub", animationDelay: 0 },
        position: { x: 0, y: 100 },
      },
      {
        id: "actions",
        type: "service",
        data: { label: "GitHub Actions", animationDelay: 0.2 },
        position: { x: 250, y: 100 },
      },
      {
        id: "argocd",
        type: "service",
        data: { label: "ArgoCD", animationDelay: 0.4 },
        position: { x: 500, y: 100 },
      },
      {
        id: "k3s",
        type: "service",
        data: { label: "K3s Cluster", animationDelay: 0.6 },
        position: { x: 750, y: 100 },
      },
    ],
    edges: [
